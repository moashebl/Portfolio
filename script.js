...
contactForm.addEventListener('submit', (e) => {
    ...
    // Create mailto link
    const mailtoLink = `mailto:mohamed.alaashebl5@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(`Name: ${name}\nEmail: ${email}\n\nMessage:\n${message}`)}`;
...
const clickableElements = document.querySelectorAll('a, button, .skill-item, .project-card');
